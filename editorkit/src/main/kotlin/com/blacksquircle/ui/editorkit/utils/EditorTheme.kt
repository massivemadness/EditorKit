...
object EditorTheme {
    ...
    val SOLARIZED_LIGHT = ColorScheme(
        ...
        selectionColor = Color.parseColor("#869496"),
    ...
    val ECLIPSE = ColorScheme(
        ...
        selectionColor = Color.parseColor("#5F73A7"),
        suggestionQueryColor = Color.parseColor("#3A6FAD"),
        findResultBackgroundColor = Color.parseColor("#E2FEDE"),
        delimiterBackgroundColor = Color.parseColor("#A4CBBC"),
        numberColor = Color.parseColor("#0000F5"),
        operatorColor = Color.parseColor("#000000"),
        keywordColor = Color.parseColor("#741453"),
        typeColor = Color.parseColor("#741453"),
        langConstColor = Color.parseColor("#741453"),
        preprocessorColor = Color.parseColor("#9A892E"),
        ...
        tagColor = Color.parseColor("#000000"),
        tagNameColor = Color.parseColor("#741453"),
        attrNameColor = Color.parseColor("#0000F5"),
        attrValueColor = Color.parseColor("#2602F5"),
        entityRefColor = Color.parseColor("#0000F5"),
    )
}